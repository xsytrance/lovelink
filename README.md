...
- Theme switcher (floating palette button with flavor + flag inspired presets).
- Enhanced memory cards with collapse/expand and tap-to-open fullscreen viewer actions (save/delete/close).
